...
// Height
    ...
    $(window).on('madxartwork/frontend/init', function () {
        ...
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-image-hotspots.default', ImageHotspotHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-image-comparison.default', ImageComparisonHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-counter.default', CounterHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-logo-carousel.default', LogoCarouselHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-info-box-carousel.default', InfoBoxCarouselHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-instafeed.default', InstaFeedPopupHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-team-member-carousel.default', TeamMemberCarouselHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-modal-popup.default', ModalPopupHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-table.default', TableHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-toggle.default', ToggleHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-countdown.default', PPCountdownHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-image-gallery.default', ImageGalleryHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-image-slider.default', ImageSliderHandler);
		...
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-buttons.default', PPButtonHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-showcase.default', ShowcaseHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-timeline.default', TimelineHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-card-slider.default', CardSliderHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-image-accordion.default', ImageAccordionHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-advanced-accordion.default', AdvancedAccordionHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-content-ticker.default', ContentTickerHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-magazine-slider.default', MagazineSliderHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-video.default', VideoHandler);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/pp-video-gallery.default', VideoGalleryHandler);
    });
